...
public class User {
	...
	public User(String name, String userName, String email, Set<String> wishList) {
		this.name = name;
	...
	public User(String id, String name, String userName, String email, Set<String> wishList) {
		this.id = id;
		this.userName = userName;
		this.email = email;
		this.wishList = wishList;
